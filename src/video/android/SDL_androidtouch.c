...
void Android_OnTouch(int touch_device_id_in, int pointer_finger_id_in, int action, float x, float y, float p, int mouseButtonIndex)
{
    ...
    switch (action) {
        case ACTION_DOWN:
            ...
            if (!separate_mouse_and_touch) {
                ...
                SDL_SendMouseButton(Android_Window, SDL_TOUCH_MOUSEID, SDL_PRESSED, mouseButtonIndex);
            }
        ...
        case ACTION_UP:
            ...
            if (!separate_mouse_and_touch) {
                /* send mouse up */
                SDL_SendMouseButton(Android_Window, SDL_TOUCH_MOUSEID, SDL_RELEASED, mouseButtonIndex);
            }
